...
def baseline_markdown(report: Dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"- claim_alignment_counts: `groups={alignment['group_count']} relations={alignment['relation_count']} methods={alignment['method_family_group_count']} conflicts={alignment['conflicting_group_count']} incomparable={alignment['incomparable_pair_count']} gaps={alignment['research_gap_count']}`",
